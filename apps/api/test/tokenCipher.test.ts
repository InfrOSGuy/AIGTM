...
beforeAll(() => {
  ...
  process.env.HUBSPOT_OAUTH_CLIENT_ID = "test-hubspot-client-id";
  process.env.HUBSPOT_OAUTH_CLIENT_SECRET = "test-hubspot-client-secret";
  process.env.HUBSPOT_WEBHOOK_SIGNING_SECRET = "test-hubspot-webhook-secret";
